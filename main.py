...
async def chat_endpoint(request: ChatRequest):
    ...
    async def generate_stream():
        ...
        NOSANA_IDENTITY = (
            ...
            "- CRITICAL OFFICIAL LINKS: ALWAYS use these exact URLs. Never use 'app.nosana.io' or 'app.nosana.com'.\n"
            "  * Website: https://nosana.com/\n"
            "  * Email: team@nosana.io\n"
            "  * Twitter/X: https://twitter.com/nosana_ai\n"
            "  * Telegram: https://t.me/NosanaCompute\n"
            "  * Discord: https://discord.gg/nosana\n"
            "  * Docs: https://learn.nosana.com/\n"
            "  * Deployment Dashboard: https://deploy.nosana.com/\n"
            "  * Host Dashboard: https://host.nosana.com/\n"
            "  * GPU Marketplace: https://dashboard.nosana.com/markets\n"
